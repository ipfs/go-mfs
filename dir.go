...
func (d *Directory) ListEntries(ctx context.Context) ([]FSNode, error) {
	var entries []FSNode
	...
	for _, name := range names {
		...
		d.uncache(name)
		// Remove the cache entry generated by `Child` to avoid using
		// too much memory.
		// TODO: Provide a `Child`-like method that doesn't cache the retrieved child.
